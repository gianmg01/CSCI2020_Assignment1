...
/**
 * This class is used to represent a Mountain Monster
 * and implements the Monster interface.
 *
 */
public class MountainMonster implements Monster{
    ...
    public void create(){
        ...
        switch (temp1){
            case 0 -> features.add("rough skin");
            case 1 -> features.add("Scaly");
            case 2 -> features.add("furry");
            default -> features.add("prickly");
        }

        temp1 = random.nextInt(3);
        switch (temp1){
            case 0 -> features.add("slithers");
            case 1 -> features.add("2 legs");
            default -> features.add("4 legs");
        }
        ...
        possibleFeaturesS.add("has wings");
        possibleFeaturesI.add(3);
        ...
        possibleFeaturesS.add("fire resistant");
        possibleFeaturesI.add(4);
        possibleFeaturesS.add("eats plants");
        possibleFeaturesI.add(0);
        possibleFeaturesS.add("eats meat");
        possibleFeaturesI.add(1);
        possibleFeaturesS.add("has goat horns");
        possibleFeaturesI.add(2);
        possibleFeaturesS.add("has hooves");
        possibleFeaturesI.add(1);
    ...
    public void printMonster(){
        System.out.println("Your New Mountain Monster's features:");
