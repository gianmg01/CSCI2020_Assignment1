...
/**
 * This class is used to represent a Forest Monster
 * and implements the Monster interface.
 */
public class ForestMonster implements Monster{
    ...
    public void create(){
        ...
        possibleFeaturesS.add("climbs trees");
        possibleFeaturesI.add(1);
        ...
        possibleFeaturesS.add("has pincers");
        possibleFeaturesI.add(2);
    ...
    public void printMonster(){
        System.out.println("Your New Forest Monster's features:");
